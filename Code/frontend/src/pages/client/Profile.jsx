      ...
      <div className="card max-w-lg">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            ...
            <span className="inline-block text-[11px] font-semibold tracking-wide px-2 py-0.5 rounded bg-blue-50 text-primary">CLIENT</span>
          </div>
        </div>
        <Row icon={Mail} label="Email Address" value={user?.email} />
        <Row icon={Phone} label="Phone Number" value={user?.phone} />
        <Row icon={Shield} label="Role" value="Client" />
